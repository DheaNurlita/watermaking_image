              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                      ...
                      decoration:
                          BoxDecoration(border: Border.all(), borderRadius: const BorderRadius.all(Radius.circular(5))),
                      width: 600,
                      height: 250,
                      child: _image == null
                          ? const Column(
                ...
                textOrImage[0]
                    ? Column(
                        children: [
                          ...
                          //   child: Text('Change Font ${isLenovoFont ? 'Arial' : 'Lenovo'}'),
                          // ),
                          Padding(
                    ...
                    : Row(
                        children: [
                          ElevatedButton(onPressed: pickImage2, child: const Text('Select Watermark image')),
                          Text(imgname)
                        ],
                      ),
                const SizedBox(
